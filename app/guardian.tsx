    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={sosStyles.overlay}>
        <View style={sosStyles.container}>
          ...
          <Text style={sosStyles.hint}>
            실제 사고라면 그냥 두세요. 자동으로 발송됩니다.
          </Text>
        </View>
      </View>
    </Modal>
          ...
          <View style={addStyles.relationGrid}>
            {RELATIONS.map((r) => (
              ...
              >
                <Text
                  style={[
                    addStyles.relationChipText,
                    relation === r && { color: "#FFFFFF" },
                  ]}
                >
                  {r}
                </Text>
...
export default function GuardianScreen() {
  ...
  const handleSosConfirm = async () => {
    ...
    await GuardianStore.triggerSos(
      "서울시 강남구 테헤란로 123",
    ...
    Alert.alert(
      ...
      [
        ...
        {
          text: "사고 신고 시작",
          onPress: () => router.push("/accident-report" as never),
        },
      ]
    );
  };
                ...
                <View style={styles.guardianInfo}>
                  ...
                  <View style={styles.guardianStatusRow}>
                    <View
                      style={[
                        styles.appStatusDot,
                        { backgroundColor: guardian.hasApp ? "#38A169" : "#A0AEC0" },
                      ]}
                    />
        ...
        <View style={styles.section}>
          ...
          {sosConfirmed && (
            <View style={styles.sosConfirmedBanner}>
              ...
              <Text style={styles.sosConfirmedText}>
                가디언에게 SOS 알림이 발송되었습니다
              </Text>
            </View>
          )}
        </View>
